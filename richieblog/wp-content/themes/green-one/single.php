...
<div class="main">
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<h1><?php the_title(); ?> <?php edit_post_link(__('Edit this entry', 'green_one'), '', ''); ?></h1>
		...
		<?php the_content(); ?>
		<?php wp_link_pages(array('before' => '<p class="pages"><strong>'.__('Pages', 'green_one').':</strong> ', 'after' => '</p>', 'next_or_number' => 'number')); ?>
