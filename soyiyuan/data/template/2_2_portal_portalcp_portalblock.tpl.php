...
0
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1421733197, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/singcere_note', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1421733197, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/singcere_note', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_nav.htm', 1421733197, '2', './data/template/2_2_portal_portalcp_portalblock.tpl.php', './template/singcere_note', 'portal/portalcp_portalblock')
