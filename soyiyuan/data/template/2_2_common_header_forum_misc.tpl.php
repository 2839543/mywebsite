...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1422286556, '2', './data/template/2_2_common_header_forum_misc.tpl.php', './template/singcere_note', 'common/header_forum_misc')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1422286556, '2', './data/template/2_2_common_header_forum_misc.tpl.php', './template/singcere_note', 'common/header_forum_misc')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1422286556, '2', './data/template/2_2_common_header_forum_misc.tpl.php', './template/singcere_note', 'common/header_forum_misc')
;?>
