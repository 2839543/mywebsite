...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1421734178, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/singcere_note', 'common/header_home_space')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1421734178, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/singcere_note', 'common/header_home_space')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1421734178, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/singcere_note', 'common/header_home_space')
;?>
