...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1427071338, '2', './data/template/2_2_common_header_search_forum.tpl.php', './template/singcere_note', 'common/header_search_forum')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1427071338, '2', './data/template/2_2_common_header_search_forum.tpl.php', './template/singcere_note', 'common/header_search_forum')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1427071338, '2', './data/template/2_2_common_header_search_forum.tpl.php', './template/singcere_note', 'common/header_search_forum')
;?>
