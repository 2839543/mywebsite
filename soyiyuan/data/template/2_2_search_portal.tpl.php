...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1422637637, '2', './data/template/2_2_search_portal.tpl.php', './template/singcere_note', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1422637637, '2', './data/template/2_2_search_portal.tpl.php', './template/singcere_note', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1422637637, '2', './data/template/2_2_search_portal.tpl.php', './template/singcere_note', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1422637637, '2', './data/template/2_2_search_portal.tpl.php', './template/singcere_note', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1422637637, '2', './data/template/2_2_search_portal.tpl.php', './template/singcere_note', 'search/portal')
;?>
