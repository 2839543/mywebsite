...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1421734565, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/singcere_note', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1421734565, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/singcere_note', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1421734565, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/singcere_note', 'common/header_forum_forumdisplay')
;?>
...
<span class="pipe">|</span>
<?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra4'])) echo $_G['setting']['pluginhooks']['global_usernav_extra4'];?><a href="home.php?mod=space&amp;do=notice" id="myprompt"<?php if($_G['member']['newprompt']) { ?> class="new"<?php } ?>  onmouseover="showMenu({'ctrlid':'myprompt'});">提醒<?php if($_G['member']['newprompt']) { ?>(<?php echo $_G['member']['newprompt'];?>)<?php } ?></a><span id="myprompt_check"></span>
