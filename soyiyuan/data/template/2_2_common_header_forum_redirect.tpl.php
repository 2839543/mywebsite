...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1426818698, '2', './data/template/2_2_common_header_forum_redirect.tpl.php', './template/singcere_note', 'common/header_forum_redirect')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1426818698, '2', './data/template/2_2_common_header_forum_redirect.tpl.php', './template/singcere_note', 'common/header_forum_redirect')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1426818698, '2', './data/template/2_2_common_header_forum_redirect.tpl.php', './template/singcere_note', 'common/header_forum_redirect')
;?>
