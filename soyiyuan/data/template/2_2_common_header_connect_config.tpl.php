...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1421732818, '2', './data/template/2_2_common_header_connect_config.tpl.php', './template/singcere_note', 'common/header_connect_config')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1421732818, '2', './data/template/2_2_common_header_connect_config.tpl.php', './template/singcere_note', 'common/header_connect_config')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1421732818, '2', './data/template/2_2_common_header_connect_config.tpl.php', './template/singcere_note', 'common/header_connect_config')
;?>
