...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1421733982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/singcere_note', 'common/header_home_spacecp')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1421733982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/singcere_note', 'common/header_home_spacecp')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1421733982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/singcere_note', 'common/header_home_spacecp')
;?>
