...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1426485235, '2', './data/template/2_2_search_forum.tpl.php', './template/singcere_note', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1426485235, '2', './data/template/2_2_search_forum.tpl.php', './template/singcere_note', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1426485235, '2', './data/template/2_2_search_forum.tpl.php', './template/singcere_note', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1426485235, '2', './data/template/2_2_search_forum.tpl.php', './template/singcere_note', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1426485235, '2', './data/template/2_2_search_forum.tpl.php', './template/singcere_note', 'search/forum')
;?>
