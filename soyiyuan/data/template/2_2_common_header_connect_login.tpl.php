...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1421734171, '2', './data/template/2_2_common_header_connect_login.tpl.php', './template/singcere_note', 'common/header_connect_login')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1421734171, '2', './data/template/2_2_common_header_connect_login.tpl.php', './template/singcere_note', 'common/header_connect_login')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1421734171, '2', './data/template/2_2_common_header_connect_login.tpl.php', './template/singcere_note', 'common/header_connect_login')
;?>
