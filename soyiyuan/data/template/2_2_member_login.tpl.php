...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1421770516, '2', './data/template/2_2_member_login.tpl.php', './template/singcere_note', 'member/login')
