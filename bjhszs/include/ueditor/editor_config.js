...
(function () {
     ...
     */
     /**  fixedpath为CMS安装目录,默认为"/",如果安装目录不为"/"请更改，注意要以"/"结尾  **/
    var fixedpath = "/";
    window.UEDITOR_HOME_URL = fixedpath + "include/ueditor/";
    var URL;
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:fixedpath                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,filePath:fixedpath                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"php/getRemoteImage.php"   //处理远程图片抓取的地址
        ,catcherPath:fixedpath                  //图片修正地址，同imagePath
        ...
        ,imageManagerPath:fixedpath                                    //图片修正地址，同imagePath
