...
if($dopost=="delete")
{
	...
	$dsql->Close();
	ShowMsg("成功删除一条挂号信息！",$ENV_GOBACK_URL);
	exit();
}
	...
	if(isset($aids) && is_array($aids))
	{
		...
		ShowMsg("成功删除指定挂号信息！",$ENV_GOBACK_URL);
		exit();
	}
	else
	{
		ShowMsg("你没选定任何挂号信息！",$ENV_GOBACK_URL);
		exit();
	}
...
else if($dopost=='saveedit')
{
	...
	ShowMsg("成功更改挂号信息！",$ENV_GOBACK_URL);
	exit();
}
