...
E_D("replace into `dede_sysconfig` values('3','cfg_cookie_encode','cookie加密码','2','string','AuLWh3732U');");
...
E_D("replace into `dede_sysconfig` values('6','cfg_indexname','主页链接名','1','string','首页');");
E_D("replace into `dede_sysconfig` values('7','cfg_webname','网站名称','1','string','重庆寺坪陵园');");
E_D("replace into `dede_sysconfig` values('8','cfg_adminemail','网站发信EMAIL','2','string','admin@ccl.com');");
E_D("replace into `dede_sysconfig` values('9','cfg_html_editor','Html编辑器（ckeditor,需要fck的用户可以去官网下载）','2','string','ueditor');");
...
E_D("replace into `dede_sysconfig` values('20','cfg_notallowstr','禁用词语（系统将直接停止用户动作）<br/>用|分开，但不要在结尾加|','5','bstring','');");
...
E_D("replace into `dede_sysconfig` values('24','cfg_df_style','模板默认风格','1','string','myweb');");
...
E_D("replace into `dede_sysconfig` values('764','dede_botcontact','底部联系信息','1','bstring','电话：400-023-6713　　　QQ：273448345<br />地址：重庆市九龙坡区石桥铺泰兴电脑城15-10');");
E_D("replace into `dede_sysconfig` values('762','dede_powerby','网站版权信息','1','bstring','Copyrihgt @ 2007-2013 @ CQGMGS.　重庆公墓销售公司　销售热线：023-63150067　2608373　手机：13941637505<br>办公地址：重庆市九龙坡区石桥铺泰兴电脑城15-10　ICP备09104784号　技术支持：重庆慧学科技有限公司');");
E_D("replace into `dede_sysconfig` values('763','dede_leftcontact','内页左侧联系信息','1','bstring','电话：13941637505<br />邮箱：WILLIAM137@126.COM<br />Q Q：273448345<br />地址：重庆市九龙坡区石桥铺泰兴电脑城15-10');");
...
E_D("replace into `dede_sysconfig` values('32','cfg_auot_description','自动摘要长度（0-250，0表示不启用）','7','number','250');");
...
E_D("replace into `dede_sysconfig` values('41','cfg_mb_open','是否开启会员功能','4','bool','N');");
E_D("replace into `dede_sysconfig` values('42','cfg_mb_album','是否开启会员图集功能','4','bool','N');");
...
E_D("replace into `dede_sysconfig` values('45','cfg_mb_sendall','是否开放会员对自定义模型投稿','4','bool','N');");
E_D("replace into `dede_sysconfig` values('46','cfg_mb_rmdown','是否把会员指定的远程文档下载到本地','4','bool','N');");
...
E_D("replace into `dede_sysconfig` values('20','cfg_replacestr','替换词语（词语会被替换成***）<br/>用|分开，但不要在结尾加|','5','bstring','她妈|它妈|他妈|你妈|去死|贱人|共产党|游行|革命|胡锦涛|江泽民|温家宝|');");
...
E_D("replace into `dede_sysconfig` values('60','cfg_arc_autopic','提取第一张图片作为缩略图','7','bool','N');");
E_D("replace into `dede_sysconfig` values('61','cfg_arc_autokeyword','自动提取关键字','7','bool','Y');");
E_D("replace into `dede_sysconfig` values('62','cfg_title_maxlen','文档标题最大长度<br>改此参数后需要手工修改数据表','7','number','100');");
...
E_D("replace into `dede_sysconfig` values('224','cfg_smtp_usermail','SMTP服务器的用户邮箱','2','string','');");
E_D("replace into `dede_sysconfig` values('225','cfg_smtp_user','SMTP服务器的用户帐号','2','string','');");
E_D("replace into `dede_sysconfig` values('226','cfg_smtp_password','SMTP服务器的用户密码','2','string','');");
...
E_D("replace into `dede_sysconfig` values('710','cfg_keywords','站点默认关键字','1','string','重庆寺坪陵园');");
E_D("replace into `dede_sysconfig` values('711','cfg_description','站点描述','1','bstring','重庆寺坪陵园');");
...
E_D("replace into `dede_sysconfig` values('745','cfg_uplitpic_cut','上传缩略图后是否马上弹出裁剪框','3','bool','N');");
